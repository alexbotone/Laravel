...
Illuminate\Support\Facades\Input; use
App\Nerd; use App\Http\Requests;
use App\Http\Controllers\Controller;
use Validator; //use Input;
use Illuminate\Database\Eloquent\Model; use
Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\ModelNotFoundException; class
NerdController extends Controller
{
 /**
 ...
 */
 ...
 {
 // load the create form (app/views/nerds/create.blade.php) return
view('nerds.create');
 }
 /**
 ...
 */
 ...
 $rules = array(
 'name' => 'required|max:255',
 'email' => 'required|email|max:255|unique:nerds', 'nerd_level'
=> 'required|numeric'
 );
 $validator = $this->validator($request->all(), $rules); if
($validator->fails()) {
 ...
 */
 ...
 // get the nerd
 $nerd = Nerd::find($id);
 // show the edit form and pass the nerd return
view('nerds.edit')->withNerd($nerd);
 }
 /**
 * @param \Illuminate\Http\Request $request
 * @param int $id
